...
# Define Pairs
pairs = np.loadtxt('AB_pairs.txt', dtype = int, delimiter = ',')
n_pairs = len(pairs)
...
for block in range(n_blocks):
    ...
    for i in range(n_trials):
        ...
        T1 = pairs[index_pairs][0]
        T2 = pairs[index_pairs][1]
        ...
        trial_sequence[t1_pos + int(lag[i])] = t2img
